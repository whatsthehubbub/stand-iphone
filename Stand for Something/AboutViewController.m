...
- (void)viewDidLoad
{
    ...
    self.aboutContent.frame = CGRectMake(self.aboutContent.frame.origin.x, self.aboutContent.frame.origin.y, self.aboutContent.frame.size.width, self.textLabel.frame.size.height + 209);
}
